...
CREATE TABLE `receipt_heading` (
  ...
  `developer_logo_path` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `receipt_heading` VALUES (1,'LUCKY SAVER HARDWARE & CONSTRUCTION SUPPLY1','Magallanes st. Kinabranan 1, Allen, Northern Samar','Elorde J. Tan - Prop.','VAT REG TIN','155-455-504-00000',0.12,NULL,'XYZ Trading Corp.','BIR-ACC-2024-00123','2024-02-28','2030-07-17','1.1.1.3','0917-XXX-XXXX | dev@abcsoft.ph',NULL,NULL);
