...
CREATE TABLE `receipt_heading` (
  ...
  `print_logo_width` int(11) NOT NULL DEFAULT 240,
  `print_logo_align` varchar(10) NOT NULL DEFAULT 'center',
  `print_logo_enabled` tinyint(1) NOT NULL DEFAULT 1,
  `developer_logo_path` varchar(500) DEFAULT NULL,
  `branch_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `receipt_heading_branch_id` (`branch_id`),
...
INSERT INTO `receipt_heading` VALUES (1,'LUCKY SAVER HARDWARE & CONSTRUCTION SUPPLY','Magallanes st. Kinabranan 1, Allen, Northern Samar','Elorde J. Tan - Prop.','VAT REG TIN','155-455-504-00000',0.12,NULL,'XYZ Trading Corp.','BIR-ACC-2024-00123','2024-02-26','2030-07-15','1.1.1.3','0917-XXX-XXXX | dev@abcsoft.ph','/api/logos/business-logo.png',240,'center',1,'/api/logos/developer-logo.png',1),(2,'LINDA LIM','BICOL, NORTHERN PASAY','N/A','N/A','N/A',12.00,NULL,'N/A','N/A',NULL,NULL,'N/A','N/A',NULL,240,'center',1,NULL,2);
...
-- Dump completed on 2026-06-22  5:22:21
