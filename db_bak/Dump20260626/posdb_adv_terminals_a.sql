...
CREATE TABLE `terminals_a` (
  ...
  PRIMARY KEY (`ID`),
  UNIQUE KEY `terminals_branch_machine_name` (`branch_id`,`machine_name`),
  UNIQUE KEY `terminals_branch_serial_number` (`branch_id`,`serial_number`),
  UNIQUE KEY `terminals_branch_min_number` (`branch_id`,`min_number`),
  UNIQUE KEY `terminals_branch_ptu_number` (`branch_id`,`ptu_number`),
...
INSERT INTO `terminals_a` VALUES (3,'POS-0001','SN-1029291','MIN-100201','PTU-593939',1,5000,76,'2025-07-01','2030-07-01','2025-07-18 13:25:34','2026-06-25 15:44:22',1,1),(4,'POS-0002','SN-355112','MIN-G25123','PTU-51231',20000,21000,20000,'2026-06-25','2027-10-25','2026-06-26 02:17:40','2026-06-26 02:18:00',1,1);
