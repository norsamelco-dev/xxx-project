...
export type ReportLayoutId = 'standard80mm'
...
export const DEFAULT_X_REPORT_LAYOUT: ReportLayoutId = 'standard80mm'
export const DEFAULT_Z_REPORT_LAYOUT: ReportLayoutId = 'standard80mm'
...
export const X_REPORT_LAYOUT_OPTIONS: Array<{ id: ReportLayoutId; label: string }> = [
  { id: 'standard80mm', label: 'X-Reading (80mm)' },
]

export const Z_REPORT_LAYOUT_OPTIONS: Array<{ id: ReportLayoutId; label: string }> = [
  { id: 'standard80mm', label: 'Z-Reading (80mm)' },
]

export const MENU_X_REPORT_LAYOUT_OPTIONS = X_REPORT_LAYOUT_OPTIONS
export const MENU_Z_REPORT_LAYOUT_OPTIONS = Z_REPORT_LAYOUT_OPTIONS
